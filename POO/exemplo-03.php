...
class Documento
{
	...
	{
		$resultado = Documento::validarCPF($numero); //os :: em seguida servem para acessar métodos estáticos
		if ($resultado === false) {
	...
	public static function validarCPF($cpf):bool
	{
		...
		{
			return false;
		//Calcula os digitos verificadores para averiguar se o CPF é válido
		} 
		else 
		{   
...
/*
	$cpf = new Documento();
	$cpf->setNumero("31022355902");

	var_dump($cpf->getNumero());
*/
var_dump(Documento::validarCPF("31022355902"));
